...
describe 'Stub' do
  it '--' do
    ...
    puts student.has_finished?(course)
  ...
  it 'Qualquer instância da classe vai obter o resultado desejado' do
  	student = Student.new
  ...
  it 'Obtendo erro desejado para um determinado método' do
  	student = Student.new
